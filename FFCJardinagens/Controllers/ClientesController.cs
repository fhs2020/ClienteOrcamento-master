...
namespace FFCJardinagens.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Empresa,Nome,Email,Telefone,Celular,CNPJ,Endereco,Cidade,UF,CEP")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Empresa,Nome,Email,Telefone,Celular,CNPJ,Endereco,Cidade,UF,CEP")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
